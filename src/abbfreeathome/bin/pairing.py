...
class Pairing(enum.Enum):
    ...
    AL_CONTROLLER_ON_OFF_REQUEST_EXT = 69
    AL_ECO_ON_OFF_EXT = 70
    AL_RELATIVE_SET_POINT_REQUEST_EXT = 71
    AL_AWAY = 80
    AL_INFO_ON_OFF = 256
    AL_INFO_FORCE = 257
    ...
    AL_OPERATION_MODE_32 = 349
    AL_INFO_OPERATION_MODE_32 = 350
    AL_INFO_SUPPORTED_OPERATION_MODE_32 = 351
    ...
    AL_INFO_SWING_MODE = 362
    AL_INFO_SUPPORTED_SWING_MODE = 363
    ...
    AL_MIN_CHARGING_CURRENT_ECO = 1236
    AL_INFO_MIN_CHARGING_CURRENT_ECO = 1237
    AL_USED_PHASES = 1238
    AL_INFO_USED_PHASES = 1239
    AL_FREE_VENDING = 1240
    AL_INFO_FREE_VENDING = 1241
    AL_INFO_MAXIMUM_CHARGING_CURRENT_LIMIT = 1242
    AL_IMPORTED_ENERGY_COST_TODAY = 1243
    AL_EXPORTED_ENERGY_COST_TODAY = 1244
    AL_TOTAL_ENERGY_COST_IMPORTED = 1245
    AL_TOTAL_ENERGY_COST_EXPORTED = 1246
    AL_PAUSE_CHARGING = 1247
    ...
    AL_INFO_RUNNING = 1584
    AL_REMOTE_START = 1585
