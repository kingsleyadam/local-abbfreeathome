...
from .devices.room_temperature_controller_master_without_fan import (
...
FUNCTION_DEVICE_MAPPING: dict[Function, Base] = {
    ...
    Function.FID_ROOM_TEMPERATURE_CONTROLLER_MASTER_WITHOUT_FAN: RoomTemperatureControllerMasterWithoutFan,
