...
FUNCTION_CHANNEL_MAPPING: dict[Function, Base] = {
    ...
    Function.FID_MWIRE_SWITCH_OUTPUT_TYPE0: MWireSwitchActuator,
    Function.FID_MWIRE_SWITCH_OUTPUT_TYPE1: MWireSwitchActuator,
    ...
    Function.FID_ROOM_TEMPERATURE_CONTROLLER_MASTER_WITH_FAN: (
    ...
    Function.FID_WELCOME_IP_MUTE_ACTUATOR: WelcomeIPMuteActuator,
